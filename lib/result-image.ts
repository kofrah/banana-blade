...
export function composeResult(frame:HTMLCanvasElement,icon:HTMLCanvasElement,line:string,rare=false){
 ...
 ctx.imageSmoothingEnabled=false;const iconHeight=150,iconWidth=iconHeight*icon.width/icon.height;ctx.drawImage(icon,1130-iconWidth,1130,iconWidth,iconHeight);
